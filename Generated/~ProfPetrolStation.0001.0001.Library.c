    ...
    void)
{
    ...
    while (ent_delivery != NULL) {
        ...
        if (
            ...
            ent_delivery->rel_being_made_using_pump_tail) {
    ...
    while (ent_pump != NULL) {
        ...
        if (
            ent_pump->rel_pumping_fuel_from_tank_head != 
            ent_pump->rel_pumping_fuel_from_tank_tail) {
        ...
        if (
            ent_pump->rel_being_used_for_delivery_head != 
            ent_pump->rel_being_used_for_delivery_tail) {
    ...
    while (ent_tank != NULL) {
        ...
        if (
            ent_tank->rel_stores_fuel_grade_head != 
            ent_tank->rel_stores_fuel_grade_tail) {
    ...
    while (ent_transaction != NULL) {
        ...
        if (
            ent_transaction->rel_governed_by_transaction_policy_head != 
            ent_transaction->rel_governed_by_transaction_policy_tail) {
        ...
        if (
            ent_transaction->rel_generalisation_pending_transaction_head != 
            ent_transaction->rel_generalisation_pending_transaction_tail) {
        ...
        if (
            ent_transaction->rel_generalisation_paid_transaction_head != 
            ent_transaction->rel_generalisation_paid_transaction_tail) {
        ...
        if (
            ent_transaction->rel_generalisation_evaded_transaction_head != 
            ent_transaction->rel_generalisation_evaded_transaction_tail) {
    ...
    while (ent_pending_transaction != NULL) {
        ...
        if (
            ent_pending_transaction->rel_pending_for_pump_head != 
            ent_pending_transaction->rel_pending_for_pump_tail) {
