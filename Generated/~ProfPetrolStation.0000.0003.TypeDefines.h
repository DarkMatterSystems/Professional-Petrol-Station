...
typedef adm_base_integer_typ adm_int_time_hour_typ;
typedef adm_base_integer_typ adm_int_time_minute_typ;
typedef adm_base_integer_typ adm_int_time_second_typ;
typedef adm_base_integer_typ adm_int_equipment_number_typ;
typedef adm_base_integer_typ adm_int_business_number_typ;

typedef adm_base_boolean_typ adm_bln_flag_typ;

typedef adm_base_fixed_typ   adm_fxd_money_typ;
typedef adm_base_fixed_typ   adm_fxd_volume_typ;

typedef adm_base_float_typ   adm_flt_level_typ;
